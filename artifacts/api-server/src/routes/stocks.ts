...
const stockDefinitions = [
  ...
  },
  {
    ...
    patternScore: 26,
    tradabilityScore: 44,
    operatorNote: "Optical genome mapping niche lacks sufficient commercial traction.",
    financialNote: "Persistent losses with dwindling cash reserves; dilution cycle continuing.",
  ...
  },
  {
    ...
    patternScore: 53,
    tradabilityScore: 61,
    operatorNote: "Diversified cannabis and retail operator; improving but uneven execution.",
    financialNote: "Revenue growing via acquisitions; path to profitability remains stretched.",
    tradeWindow: "5–14 days",
    entryZone: "$0.68–$0.71",
    targetZone: "$0.83–$0.94",
    stopZone: "$0.62",
    status: "Management Action Likely",
    volume: "3.1M",
    chart: [
  ...
  },
  {
    ...
    patternScore: 62,
    tradabilityScore: 74,
    operatorNote: "Diversified cannabis-to-craft-beer pivot shows management adaptability.",
    financialNote: "Revenue scale present; near-term profitability dependent on cost discipline.",
    tradeWindow: "6–19 days",
    entryZone: "$0.83–$0.86",
    targetZone: "$0.99–$1.09",
    stopZone: "$0.77",
    status: "Recovery Candidate",
    volume: "7.2M",
    chart: [
  ...
  },
  {
    ...
    patternScore: 46,
    tradabilityScore: 58,
    operatorNote: "Last-mile delivery drone and truck platform; FAA certification delays hurt.",
    financialNote: "Minimal deliveries; cash consumption outpacing any commercial traction.",
    tradeWindow: "4–11 days",
    entryZone: "$0.43–$0.47",
    targetZone: "$0.57–$0.67",
    stopZone: "$0.38",
    status: "Management Action Likely",
    volume: "1.6M",
    chart: [
  ...
  },
  {
    ...
    price: 0.42,
    exchange: "NASDAQ",
    industry: "Biotech / Neurology",
    daysUnderOne: 93,
    daysToDeadline: 87,
    bounceProbability: 41,
    delistingRisk: 64,
    complianceScore: 46,
    financialScore: 23,
    operatorScore: 49,
    ...
    patternScore: 43,
    tradabilityScore: 37,
    operatorNote: "ALS and MS pipeline with Phase 2 readouts; data-driven catalysts ahead.",
    financialNote: "Pre-revenue clinical stage; runway hinges on next financing round.",
    tradeWindow: "3–10 days",
    entryZone: "$0.38–$0.41",
  ...
  },
  {
    ...
    patternScore: 49,
    tradabilityScore: 52,
    operatorNote: "China-US EV play; regulatory complexity adds meaningful execution risk.",
    financialNote: "Low-cost EV model has regional demand; US expansion progress is slow.",
    tradeWindow: "4–12 days",
    entryZone: "$0.48–$0.52",
  ...
  },
  {
    ...
    patternScore: 33,
    tradabilityScore: 47,
    operatorNote: "AI-powered consumer products platform; growth stalled post-pandemic.",
    financialNote: "Revenue declining; cost cuts ongoing but profitability still distant.",
    tradeWindow: "2–7 days",
    entryZone: "$0.34–$0.37",
  ...
  },
  {
    ...
    patternScore: 44,
    tradabilityScore: 59,
    operatorNote: "Medicare Advantage insurer with technology-driven care model; growth slowing.",
    financialNote: "Medical loss ratios improving; full profitability remains a multi-year story.",
    tradeWindow: "4–12 days",
    entryZone: "$0.41–$0.44",
